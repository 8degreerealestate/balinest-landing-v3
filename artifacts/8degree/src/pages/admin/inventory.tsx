...
export default function AdminInventory() {
  ...
  const channelBadge = (ch: string) => {
    ...
    if (ch === "rentals") return "bg-emerald-100 text-emerald-800";
    return "";
  };
      ...
      <div className="flex gap-3 mb-6 flex-wrap">
        <Select value={channel} onValueChange={handleChannelChange}>
          ...
          <SelectContent>
            ...
            <SelectItem value="website">Website (property listings)</SelectItem>
            <SelectItem value="rentals">Rentals (rental list)</SelectItem>
          </SelectContent>
        </Select>
      </div>
